...
<meta property="og:image" content="https://flockstopscrime.com/__OG_IMAGE__">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="https://flockstopscrime.com/__OG_IMAGE__">
<style>
  :root {
    --ground: #f6f8fb;
    --card: #ffffff;
  ...
  * { box-sizing: border-box; }
  ...
  table { border-collapse: collapse; width: 100%; font-size: 0.9rem; min-width: 960px; }
  ...
  <div class="table-wrap">
    <table>
      <thead><tr>
        ...
        <th class="sortable" data-sort="added">Added <span class="arrow"></span></th>
...
(function () {
  ...
  function sourceCell(r) {
    ...
    (r.additional_sources || "").split(" ").filter(Boolean).forEach(function (u, i) {
      links.push('<a class="srclink" href="' + esc(u) + '" rel="nofollow noopener" title="Additional source">+' + (i + 1) + "</a>");
    });
  ...
  function renderTable(rows) {
    var body = rows.slice(0, shown).map(function (r) {
      return "<tr>" +
        ...
        '<td class="date">' + esc(r.date_added || "") + "</td>" +
    ...
    document.getElementById("rows").innerHTML =
      body || '<tr><td colspan="9" style="color:#64748b">No matching stories.</td></tr>';
  ...
  function sortVal(r) {
    ...
    if (sortKey === "added") return r.date_added || "";
  ...
  document.querySelectorAll("th.sortable").forEach(function (th) {
    th.addEventListener("click", function () {
      ...
      if (sortKey === k) { sortDir = -sortDir; } else { sortKey = k; sortDir = (k === "date" || k === "added") ? -1 : 1; }
      render();
    });
  });
